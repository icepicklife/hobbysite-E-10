...
from .views import CommissionListView, CommissionDetailView, CommissionCreateView, CommissionUpdateView, JobApplicationUpdateView
...
urlpatterns = [
    ...
    path('jobapp/<int:pk>/evaluate', JobApplicationUpdateView.as_view(), name='application_update' )
]
