...
class CommissionAdmin(admin.ModelAdmin):
    list_display = ('title', 'get_author_display_name', 'get_author_username', 'status', 'created_on', 'updated_on')
    list_filter = ('status', 'created_on')
    search_fields = ('title', 'description', 'author__display_name', 'author__user__username')
    ordering = ('created_on',)
